...
export const TERMS: Record<string, string> = {
  ...
  fallback:
    'Шаблонный режим: ключ LLM не задан или запрос к модели упал. Объяснения собраны детерминированно из той же трассы расчёта, поэтому числа в них верные — живой только язык.',
}
